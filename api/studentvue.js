...
.cal-cell{height:80px;background:var(--surface);border:1px solid var(--border);border-radius:4px;padding:5px;cursor:pointer;transition:border-color 0.12s;position:relative;overflow:hidden;display:flex;flex-direction:column;}
.cal-cell:hover{border-color:var(--border2);}
.cal-cell.today{border-color:var(--ink);border-width:2px;}
.cal-cell.selected{border-color:var(--ink);background:var(--surface2);}
.cal-cell.other{background:var(--surface2);opacity:0.4;}
.cal-num{font-family:var(--ff-m);font-size:10px;font-weight:500;margin-bottom:2px;color:var(--ink2);flex-shrink:0;}
.cal-cell.today .cal-num{font-weight:700;color:var(--ink);}
.cal-cell.selected .cal-num{color:var(--ink);font-weight:700;}
.cal-ev{font-size:8px;padding:1px 4px;border-radius:2px;margin-bottom:1px;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;font-family:var(--ff-s);font-weight:500;display:flex;align-items:center;gap:2px;flex-shrink:0;}
...
.cal-more{font-size:8px;color:var(--ink3);font-family:var(--ff-m);padding:0 2px;line-height:1.4;}
.cal-key{display:flex;flex-wrap:wrap;gap:12px;align-items:center;padding:8px 12px;background:var(--surface);border:1px solid var(--border);border-radius:var(--r);margin-bottom:10px;}
...
/* Day sidebar */
.day-sb{width:220px;min-width:220px;background:var(--surface);border:1px solid var(--border);border-radius:var(--r);display:flex;flex-direction:column;max-height:calc(80px * 6 + 2px * 5 + 28px);overflow:hidden;}
.day-sb-hd{padding:12px 14px;border-bottom:1px solid var(--border);flex-shrink:0;}
.day-sb-date{font-family:var(--ff-d);font-size:16px;font-weight:700;letter-spacing:-0.3px;}
.day-sb-sub{font-family:var(--ff-m);font-size:9px;color:var(--ink3);letter-spacing:1px;text-transform:uppercase;margin-top:2px;}
.day-sb-body{flex:1;overflow-y:auto;padding:8px;}
.day-sb-empty{padding:16px 14px;text-align:center;color:var(--ink4);font-size:12px;font-family:var(--ff-m);}
.day-ev-row{display:flex;align-items:flex-start;gap:8px;padding:8px 10px;border-radius:var(--r);border:1px solid var(--border);margin-bottom:5px;cursor:pointer;transition:border-color 0.12s;}
.day-ev-row:hover{border-color:var(--border2);}
.day-ev-row.sel{background:var(--surface2);border-color:var(--ink);}
.day-ev-check{width:16px;height:16px;border:1px solid var(--border2);border-radius:3px;flex-shrink:0;margin-top:1px;display:flex;align-items:center;justify-content:center;font-size:9px;background:var(--surface);}
...
function CalendarPage({ events, setEvents }) {
  ...
  return (
    <div className="page fu" style={{paddingRight:20}}>
      <div className="ph">
